...
async def admin_panel(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        "<b>Админка</b>\n\n"
        "📊 <b>Статистика</b> — подписчики, продавцы, бан-лист и тестовый режим.\n"
        "🧪 <b>Тестовый режим</b> — отключить личные рассылки пользователям во время проверок.\n"
        "🛒 <b>Продавцы</b> — добавить или удалить продавца.\n"
        "🚫 <b>Бан-лист</b> — добавить, удалить и посмотреть забаненных.\n"
        "🆘 <b>SOS сообщения</b> — посмотреть и удалить SOS-заявки.\n"
        "📊 <b>Голосование</b> — отправить опрос подписчикам.",
